...
# create filename
FILENAME=$IMGDIR/gel_exposure${SETTING}_${TIME}_+raw.png
# write out exposure time
echo "SETTING is: $SETTING"
echo "starting to take picture"
raspistill -w 2592 -h 1944 -o $FILENAME -n -t 1 -ex off -ss $SETTING -awb off -awbg 1.8,3 -ag 10.67 -dg 1.0 -r -set
...
# set iso?? set binning or camera mode?
