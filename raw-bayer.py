...
# axarr[1, 1].imshow(red, cmap='gray', vmin=0, vmax=255)
# axarr[1, 1].set_title('red')

axarr[0, 0].imshow(green1, cmap='gray', vmin=0, vmax=255)
axarr[0, 0].set_title('green1')
axarr[0, 1].imshow(green1, cmap='gray_r', vmin=0, vmax=255)
axarr[0, 1].set_title('green1')
axarr[1, 0].imshow(green1,cmap='gray',norm=None)
axarr[1, 0].set_title('green1')
axarr[1, 1].imshow(green1, cmap='gray', vmin=0, vmax=1024)
